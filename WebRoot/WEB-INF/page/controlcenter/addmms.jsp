				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-content">
							...
							<html:form action="/manag/add/mmsUI" method="post"
								enctype="multipart/form-data" styleClass="form-horizontal" onsubmit="return checkfm(this)" >
								<INPUT TYPE="hidden" NAME="method" value="addmms">
								<html:hidden property="h_id" />
								<fieldset>
									<div class="control-group">
									<label class="control-label" for="fileInput">彩信图片</label>
									<div class="controls">
										<input class="input-file uniform_on" id="fileInput"
											name="mms_pic" type="file">
									</div>
									</div>
									<div class="control-group">
										<label class="control-label" for="textarea2">短信内容</label>
										<div class="controls">
											<textarea id="textarea2" rows="6" name="mms_cont"></textarea>
										</div>
									</div>
