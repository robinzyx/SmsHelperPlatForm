				...
				<div class="row-fluid sortable">
					<div class="box span12">
						...
						<div class="box-content">
							...
							<html:form action="/manag/holiday/addholiday" method="post"
								enctype="multipart/form-data" styleClass="form-horizontal"
								onsubmit="return checkfm(this)">

								<INPUT TYPE="hidden" NAME="method" value="addHoliday">
								<fieldset>
									<div class="control-group">
										<label class="control-label" for="typeahead">节日名称 </label>
										<div class="controls">
											<input type="text" class="span6 typeahead" id="typeahead"
												name="h_name" data-provide="typeahead" data-items="4"
									...
									<div class="control-group">
										...
										<div class="controls">
											<select id="selectError" data-rel="chosen" name="month">
												<option>01/01</option>
									...
									<div class="control-group">
										<div class="control-label"><input id="textInput" class="input-text" style="width: 50px" type="text" name="itemOneTitle" /></div>
										<div class="controls">
											<textarea id="textarea2" rows="3" name="itemOneCont"></textarea>
										</div>
									</div>
									<div class="control-group">
										<div class="control-label"><input id="textInput" class="input-text" style="width: 50px" type="text" name="itemTwoTitle" /></div>
										<div class="controls">
											<textarea id="textarea2" name="itemTwoCont" rows="3"></textarea>
										</div>
									</div>
									<div class="control-group">
										<div class="control-label"><input id="textInput" class="input-text" style="width: 50px" type="text" name="itemThreeTitle" /></div>
										<div class="controls">
											<textarea id="textarea2" name="itemThreeCont" rows="3"></textarea>
										</div>
									</div>
									<div class="control-group">
										<div class="control-label"><input id="textInput" class="input-text" style="width: 50px" type="text" name="itemFourTitle" /></div>
										<div class="controls">
											<textarea id="textarea2" name="itemFourCont" rows="3"></textarea>
										</div>
									</div>
