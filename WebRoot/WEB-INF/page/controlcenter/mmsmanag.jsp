	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div id="content" class="span10">
				...
				<a data-rel="tooltip" title="${record }" class="well span3 top-block" href="/manag/mms/mmsListUI.do">
				...
				<div class="row-fluid sortable">
						...
						<html:form action="/manag/mms/mmsList" method="post">
							<html:hidden property="page" />
							<html:hidden property="h_id" />
							<html:hidden property="mms_id" />
							<html:hidden property="mms_cont" />
							<html:hidden property="mms_pic" />
							...
							<div class="box-content">
								<table
									...
									<tbody>
										<c:forEach items="${mmsPageView.records}" var="entry">
											<tr>
												<td class="center">${entry.mms_id }</td>
												<td class="center">${entry.holiday.h_id }</td>
												<td class="center">${entry.mms_cont }</td>
												<td class="center"><img  src="${entry.mms_pic }" width="50"></td>
												<td class="center"><a class="btn btn-info" href="#">
														<i class="icon-edit icon-white"></i> 编辑 </a> <a
													class="btn btn-danger" href="<html:rewrite action="/manag/mms/delete.do?"/>mms_id=${entry.mms_id}"> <i
